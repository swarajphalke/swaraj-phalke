      ...
      <div className="custom-project-container">
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <div className='bg-white p-4 rounded-xl shadow-md'>
                <img src="/images/Blog_Common_Image_Next_OG_Image_8ab5e85f77.png" className="rounded-xl" />
                <a href="#">
            ...
            <div className='bg-white p-4 rounded-xl shadow-md'>
                <img src="/images/online-message-blog-chat-communication-envelop-graphic-icon-concept_53876-139717.avif" className="rounded-xl" />
